...
class SubtitleApp(QWidget):
    ...
    def initUI(self):
        ...
        self.subtitle_text.setFixedHeight(300)  # Set a fixed height for the text edit
        self.subtitle_text.setFixedWidth(580)  # Set a fixed width for the text edit
        ...
        self.status_label.setFixedWidth(580)  # Set a fixed width for the status label
