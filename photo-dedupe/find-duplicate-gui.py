...
class DuplicateResolver(QWidget):
    ...
    def update_images(self):
        ...
        if self.current_index < len(self.duplicates):
            ...
            self.left_label.setPixmap(QPixmap(left_image).scaled(half_screen_width, half_screen_width, Qt.KeepAspectRatio))
            self.right_label.setPixmap(QPixmap(right_image).scaled(half_screen_width, half_screen_width, Qt.KeepAspectRatio))
